  ...
  const handleSubmit = (e) => {
    ...
    fetch("https://formsubmit.co/ajax/wickgeninfo@gmail.com", {
      ...
      .catch((error) => {
        ...
        // Fallback to success state so user has a good experience even if offline
        setIsSuccess(true);
        setFormData({
          name: "",
          email: "",
      ...
      <section className="relative border-t border-slate-100 py-16 bg-slate-50 w-full overflow-hidden text-slate-800">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 w-full flex justify-center">
            <div className="w-full max-w-[450px] bg-white border border-slate-200/60 p-6 rounded-2xl relative shadow-sm">
              <div className="mb-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                {isSuccess && (
                  <div className="p-3.5 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-600 text-xs font-medium flex items-center gap-2">
                ...
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`w-full glass-input text-xs px-3 py-2 rounded-lg focus:outline-none focus:border-blue-500 text-slate-900 font-medium ${errors.subject ? "border-red-500 focus:border-red-500" : ""}`}
                  >
                  ...
                  {errors.subject && (
                    <p className="text-[10px] text-red-500">{errors.subject}</p>
                  )}
                </div>
          ...
          <div className="lg:col-span-6 flex flex-col gap-6">
            {/* Info Card */}
            <div className="p-6 rounded-2xl bg-white border border-slate-200/60 shadow-sm grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-semibold text-slate-900 text-sm">Hours</h4>
                </div>
                <p className="text-slate-600 text-xs leading-relaxed">
                  Monday - Friday
                  <br />
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-semibold text-slate-900 text-sm">Emails</h4>
                </div>
                <p className="text-slate-600 text-xs leading-relaxed">
                  General:{" "}
                  <a
            ...
            {/* Interactive Map */}
            <div className="flex-grow min-h-[300px] border border-slate-200/60 rounded-2xl overflow-hidden shadow-sm">
              <Map />
            </div>
          </div>
        </div>
