      ...
      <div className="bg-slate-50 w-full border-t border-slate-200/50 py-8 text-slate-800 relative z-10">
        ...
        <section className="max-w-6xl mx-auto px-6 py-8 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="mb-4 bg-blue-50 w-max p-4 rounded-xl border border-blue-100 text-blue-600">
          ...
          <div className="space-y-4">
            {frontendFeatures.map((f, i) => (
              <motion.div
                ...
                className="p-5 rounded-xl bg-white border border-slate-200/60 shadow-sm flex items-start gap-4"
              >
                <div className="mt-1 bg-blue-50 p-2 rounded-lg shrink-0 text-blue-600 border border-blue-100">
                  {f.icon}
                </div>
                <div>
        ...
        {/* Backend Details */}
        <section className="max-w-6xl mx-auto px-6 py-16 relative z-10 border-t border-slate-200 mt-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 order-2 lg:order-1">
            {backendFeatures.map((f, i) => (
              <motion.div
                ...
                className="p-5 rounded-xl bg-white border border-slate-200/60 shadow-sm flex items-start gap-4"
              >
                <div className="mt-1 bg-emerald-50 p-2 rounded-lg shrink-0 text-emerald-600 border border-emerald-100">
                  {f.icon}
                </div>
                <div>
                  <h3 className="text-base font-bold text-slate-900 mb-1">
          ...
          <div className="space-y-6 order-1 lg:order-2 lg:pl-6">
            <div className="mb-4 bg-emerald-50 w-max p-4 rounded-xl border border-emerald-100 text-emerald-600">
              <Server className="h-10 w-10 text-emerald-600" />
            </div>
            <h2 className="text-3xl font-bold text-slate-900 tracking-tight">
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 relative z-10 border-t border-slate-200 mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {frontendTechnologies.map((tech) => (
                  <div
                    key={tech.name}
                    className="p-4 rounded-xl border border-slate-200/60 bg-white shadow-sm transition-all hover:shadow-md"
                  >
            ...
            {/* Backend Tech */}
            <div className="space-y-6">
              <h3 className="text-lg font-bold text-emerald-600 border-b border-slate-200 pb-2">
                Backend Stack
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
